...
const TermsOfUse = () => {
  return (
    <SMain>
      <h1>Sellog 개인정보처리방침</h1>

      <h2>1. 개인정보처리방침이란?</h2>
      <p>
        Sellog는 이용자의 ‘동의를 기반으로 개인정보를 수집·이용 및 제공’하고
        있으며, ‘이용자의 권리 (개인정보 자기결정권)를 적극적으로 보장’합니다.
      </p>
      <p>
        Sellog는 정보통신서비스제공자가 준수하여야 하는 대한민국의 관계 법령 및
        개인정보보호 규정, 가이드라인을 준수하고 있습니다.
      </p>
      <p>
        '개인정보 처리방침'이란 이용자의 소중한 개인정보를 보호함으로써 이용자가
        안심하고 서비스를 이용할 수 있도록 sellog가 준수해야 할 지침을
        의미합니다.
      </p>
      <p className="last">본 개인정보 처리방침은 sellog에 적용됩니다.</p>

      <h2>2. 개인정보 수집</h2>
      <p>서비스 제공을 위한 필요 최소한의 개인정보를 수집하고 있습니다.</p>
      <p>
        모든 이용자는 sellog가 제공하는 서비스를 이용할 수 있고, 회원가입을 통해
        더욱 다양한 서비스를 제공받을 수 있습니다. 이용자의 개인정보를 수집하는
        경우에는 반드시 사전에 이용자에게 해당 사실을 알리고 동의를 구하도록
        하겠습니다. 수집하는 개인정보는 다음과 같습니다.
      </p>
      <p>
        회원 가입 및 서비스 이용 과정에서 아래와 같은 최소한의 개인정보를
        수집하고 있으며, 이용자의 동의없이 민감정보를 수집하지 않습니다.
      </p>
      <ul>
        <li>
        ...
        <li className="li-last">
          &#183; 민감정보란? : 이용자의 사생활을 침해할 우려가 있는 정보 (인종,
          사상 및 신조, 정치적 성향이나 범죄기록, 의료정보 등)
        </li>
      </ul>

      <h3>[회원가입시]</h3>
      <p className="li-last">필수: 이메일주소</p>
      ...
      <p className="last">
        ...
        아이디), IP주소, 쿠키, 방문일시, 서비스 이용 기록 등의 정보가 자동으로
        생성되어 수집될 수 있습니다.
      </p>
      ...
      <ul>
        ...
        <li>
          &#183; 서비스 이용 기록, 접속 빈도 및 서비스 이용에 대한 통계, 맞춤형
          서비스 제공, 서비스 개선에 활용
        </li>
      </ul>
    </SMain>
