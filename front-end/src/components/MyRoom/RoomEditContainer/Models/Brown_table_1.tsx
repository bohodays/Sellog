...
export function Brown_table_1(props: JSX.IntrinsicElements["group"] | any) {
  ...
  return (
    <group
      ...
      userData={{ draggable: true, name: "Brown_table_1" }}
      onClick={() => {
        if (props.activePage === "myitems") {
          if (!isDragging) setIsDragging(true);
          setTarget("Brown_table_1");
        }
      }}
