...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/yellow_sofa_1.glb') as GLTFResult
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.Sofa.geometry} material={materials.Wood} position={[-0.02, -0.24, -0.08]} scale={0.74}>
...
useGLTF.preload('/yellow_sofa_1.glb')
