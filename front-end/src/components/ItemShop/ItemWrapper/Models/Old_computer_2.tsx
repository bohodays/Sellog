...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/old_computer_2.glb') as GLTFResult
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.Keyboard001.geometry} material={materials['computer-beige']} position={[0.34, 1.83, 0.42]} rotation={[0, 0.63, 0]} scale={1.25}>
        <mesh geometry={nodes.Plane018.geometry} material={materials.grey} position={[-0.04, 0.05, 0.03]} rotation={[0.08, 0, 0]} />
      </mesh>
      <mesh geometry={nodes.PC002.geometry} material={materials['computer-beige']} position={[-0.62, 1.82, -0.47]} rotation={[0, 0.92, 0]} scale={1.25}>
        ...
        <group position={[-0.47, 0.12, 0.45]} rotation={[Math.PI / 2, 0, 0]}>
          <mesh geometry={nodes.Plane010.geometry} material={materials['computer-beige']} />
      ...
      <mesh geometry={nodes.Cable002.geometry} material={materials['computer-beige']} position={[0.22, 1.87, 0.2]} />
    </group>
  )
}

useGLTF.preload('/old_computer_2.glb')
