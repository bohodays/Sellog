...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/red_sofa_1.glb') as GLTFResult
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.Sofa.geometry} material={materials['red.001']} position={[-0.01, 0, 0]} rotation={[0, -0.02, 0]} scale={1.2}>
...
useGLTF.preload('/red_sofa_1.glb')
