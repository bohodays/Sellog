...
export function Blue_chair_2(props: JSX.IntrinsicElements["group"] | any) {
  ...
  return (
    <group
      ...
      userData={{ draggable: true, name: "Blue_chair_2" }}
      onClick={() => {
        if (props.activePage === "myitems") {
          if (!isDragging) setIsDragging(true);
          setTarget("Blue_chair_2");
        }
      }}
