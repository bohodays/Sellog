...
export function Black_teatable_1(props: JSX.IntrinsicElements["group"] | any) {
  ...
  return (
    <group
      ...
      userData={{ draggable: true, name: "Black_teatable_1" }}
      onClick={() => {
        if (props.activePage === "myitems") {
          if (!isDragging) setIsDragging(true);
          setTarget("Black_teatable_1");
        }
      }}
      rotation={[0, THREE.MathUtils.degToRad(rotation), 0]}
    >
      <mesh geometry={nodes.Table001.geometry} material={materials.Metal}>
        <mesh
