...
export function Round_table_1(props: JSX.IntrinsicElements["group"] | any) {
  ...
  return (
    <group
      ...
      userData={{ draggable: true, name: "Round_table_1" }}
      onClick={() => {
        if (props.activePage === "myitems") {
          if (!isDragging) setIsDragging(true);
          setTarget("Round_table_1");
        }
      }}
