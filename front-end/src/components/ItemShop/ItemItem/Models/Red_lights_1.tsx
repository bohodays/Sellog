...
export function Red_lights_1(props: JSX.IntrinsicElements["group"] | any) {
  ...
  return (
    <group
      ...
      userData={{ draggable: true, name: "Red_lights_1" }}
      onClick={() => {
        if (props.activePage === "myitems") {
          if (!isDragging) setIsDragging(true);
          setTarget("Red_lights_1");
        }
      }}
