...
export function Retro_arcadegame_1(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF("/retro_arcadegame_1.glb") as GLTFResult;
  return (
...
useGLTF.preload("/retro_arcadegame_1.glb");
