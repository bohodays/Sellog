...
Command: npx gltfjsx@6.1.4 ./public/models/items/bed.glb -t
*/
...
export function Bed(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF("/models/items/bed.glb") as GLTFResult;
  return (
...
useGLTF.preload("/models/items/bed.glb");
