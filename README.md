...
- 유저가 선택한 캐릭터와 맵이 3D로 표시됩니다.
- 유저가 맵을 자유롭게 돌아다닐 수 있으며, 특정 위치로 이동할 시 해당 서비스에 대한 페이지로 이동할 수 있는 버튼이 표시됩니다.
- 우측 상단의 토글 버튼을 통해 원하는 페이지로 이동할 수 있습니다.
