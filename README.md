...
## ❓기획 배경
```
실력있는 개발자가 되기위해 필요한 덕목이 '꾸준함'인데, 막상해보면 일이 되버리고 재미를 잃어버리면서 지속하기 어렵다. 이를 도와주기 위해 CS문제 풀기, TECH FEED 읽기, 목표 설정, 3D 마이 프로필을 꾸밀수 있게해서 본인이 목표를 달성하면서 성취감도 느끼고 프로필도 꾸미면서 재미도 가져갈 수 있게 기획하게 되었다.
```
## 💡 서비스 소개
