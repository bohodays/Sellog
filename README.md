...
> 실력있는 개발자가 되기위해 필요한 덕목이 '꾸준함'인데, 막상해보면 일이 되버리고 재미를 잃어버리면서 지속하기 어렵습니다. <br />
...
> 또한 유저의 편의성을 위해 유저가 설정한 목표를 저희가 자동으로 감지해서 달성 여부를 판단하면 좋을 것 같다는 생각에서 `Sellog`를 기획하게 되었습니다.
